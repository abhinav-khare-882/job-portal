    ...
    <div className="w-2/3">
      ...
      <div>
        ...
        <div className="text-mine-shaft-300 text-justify">
          ...
          mollitia officia numquam voluptates sint ratione quidem eum soluta
          esse nemo neque ex possimus quod asperiores nulla, dolorem omnis porro
          earum minima cum autem similique consequatur in. Adipisci perspiciatis
          modi veritatis?
        </div>
      </div>
    </div>
