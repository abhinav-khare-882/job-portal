...
const JobCategory = () => {
  return (
    <div className="mt-20 pb-5 ">
      <div className="mb-3 text-4xl text-center font-semibold text-mine-shaft-100">
      ...
      <Carousel
        ...
        "
        nextControlIcon={<IconArrowRight className="h-8 w-8 rounded-full" />}
        previousControlIcon={<IconArrowLeft className="h-8 w-8 rounded-full" />}
      >
